...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section className="relative min-h-screen pt-28 pb-16 flex flex-col justify-between overflow-hidden bg-[#08080a] text-white">
      {/* Background Gradients & Mesh Glows */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-red-600/15 blur-[140px] rounded-full pointer-events-none" />
      <div className="absolute top-1/3 right-10 w-[450px] h-[450px] bg-rose-900/15 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-[500px] h-[300px] bg-amber-600/10 blur-[130px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full my-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            {/* Tagline Badge */}
            <div className="inline-flex items-center space-x-2 bg-red-500/10 border border-red-500/20 px-3 py-1 rounded-full text-red-400 text-[10px] font-bold uppercase tracking-[0.2em]">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <button
                onClick={onOpenDemo}
                className="px-6 py-3.5 rounded-full bg-red-600 hover:bg-red-500 text-white font-semibold text-sm flex items-center space-x-2 shadow-lg shadow-red-600/30 transition-all transform hover:-translate-y-0.5"
              >
              ...
              >
                <div className="w-6 h-6 rounded-full bg-red-500/20 flex items-center justify-center text-red-400 group-hover:bg-red-600 group-hover:text-white transition-colors">
              ...
              <button
                onClick={onOpenRoi}
                className="text-xs font-semibold text-rose-400 hover:text-rose-300 underline underline-offset-4 flex items-center space-x-1 py-2"
              >
            ...
            <div className="pt-6 grid grid-cols-3 gap-3 border-t border-white/10 max-w-lg">
              <div className="glass-panel p-3.5 rounded-2xl">
                ...
                <div className="text-lg font-bold text-rose-400 flex items-center space-x-1">
                  <span>12.4 ms</span>
              ...
              <div className="glass-panel p-3.5 rounded-2xl">
                ...
                <div className="text-lg font-bold text-red-500 flex items-center space-x-1">
                  <span>1,420</span>
              ...
              <div className="glass-panel p-3.5 rounded-2xl">
                ...
                <div className="text-lg font-bold text-amber-500 flex items-center space-x-1">
                  <span>4.8 PB/s</span>
      ...
      <div className="relative z-10 mt-12 border-t border-b border-white/10 bg-black/60 py-5 backdrop-blur-md overflow-hidden">
            ...
            <div className="animate-marquee flex items-center space-x-12">
              {[...PARTNER_LOGOS, ...PARTNER_LOGOS, ...PARTNER_LOGOS].map((partner, idx) => (
                <div
                  ...
                  className="flex items-center space-x-2 text-slate-300 hover:text-red-400 transition-colors whitespace-nowrap group cursor-default shrink-0"
                >
                  <span className="font-bold text-sm tracking-wider">{partner.name}</span>
                  <span className="text-[10px] text-slate-500 group-hover:text-red-400 font-mono">({partner.symbol})</span>
                </div>
              ))}
            </div>
          </div>
