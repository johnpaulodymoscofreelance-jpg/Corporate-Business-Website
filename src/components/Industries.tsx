...
export const Industries: React.FC<IndustriesProps> = ({ onOpenDemo }) => {
  ...
  return (
    <section id="industries" className="py-24 bg-[#08080a] relative border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">
            Tailored for <span className="gradient-text">Mission-Critical Domains</span>
          </h2>
        ...
        <div className="bg-slate-950/90 border border-red-900/40 rounded-3xl p-6 sm:p-10 backdrop-blur-2xl shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-rose-400 font-mono">{activeIndustry.tagline}</p>
                </div>
              </div>
              ...
              <div className="bg-slate-900/80 p-4 rounded-2xl border border-red-500/20">
                <span className="text-[10px] text-rose-400 uppercase font-mono tracking-wider block mb-1">PROVEN IMPACT:</span>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {activeIndustry.compliance.map((c) => (
                    <span key={c} className="px-3 py-1 rounded-lg bg-red-950/60 border border-red-800/40 text-[11px] font-mono text-rose-300 flex items-center space-x-1">
            ...
            <div className="lg:col-span-5 bg-slate-900/60 p-6 rounded-2xl border border-slate-800 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {activeIndustry.keyMetrics.map((m, i) => (
                  <div key={i} className="bg-slate-950 p-4 rounded-xl border border-slate-800">
                    ...
                    <span className="text-xl font-bold text-red-400 font-mono">{m.value}</span>
                  </div>
                ))}
              </div>
              ...
              <button
                onClick={onOpenDemo}
                className="w-full py-3 rounded-xl bg-red-600 hover:bg-red-500 text-white font-bold text-xs flex items-center justify-center space-x-2 transition-all shadow-lg shadow-red-600/30"
              >
